...
export const queryKeys = {
  ...
  director: {
    homeSummary: (centerId: string) => ['director', 'home', centerId] as const,
    joinRequests: (status: string) => ['director', 'join-requests', status] as const,
    invitations: (centerId: string) => ['director', 'invitations', centerId] as const,
  },
  profile: {
