...
/**
 * The parent's menu-history filter: by meal type and by date — the same sheet
 * the teacher board uses, minus the staff status axis (parents only see
 * published meals). Carries the web parent page's type + period filters.
 */
