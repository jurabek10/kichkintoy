                ...
                {totalPages > 1 ? (
                  <View className="mt-1 flex-row items-center justify-between">
                    <Pressable
                      ...
                      hitSlop={8}
                      className={cn('h-10 w-10 items-center justify-center rounded-full border border-border', safePage === 0 ? 'opacity-40' : 'bg-card')}>
                    ...
                    <Pressable
                      ...
                      onPress={() => setPage(safePage + 1)}
                      hitSlop={8}
                      className={cn('h-10 w-10 items-center justify-center rounded-full border border-border', safePage >= totalPages - 1 ? 'opacity-40' : 'bg-card')}>
